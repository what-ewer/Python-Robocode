...
x = np.arange(buckets)
fig, ax = plt.subplots()
ax.bar(x - 0.2, [places[0] for places in num_places], 0.2, label='1st')
ax.bar(x, [places[1] for places in num_places], 0.2, label='2nd')
ax.bar(x + 0.2, [places[2] for places in num_places], 0.2, label='3rd')
ax.bar(x + 0.4, [places[3] for places in num_places], 0.2, label='4th')
